...
# ======================================================================
# This controller handles requests for recipes within the API v1 namespace.
# Ensure this file exists in `app/controllers/api/v1/` directory.
module Api
  module V1
    # Inherit from the top-level ApplicationController using `::`
    class RecipesController < ::ApplicationController
      ...
      def index
        ...
        all_recipes = [
          ...
          { id: 7, title: "Roasted Potatoes", ingredients: "Potato, Olive Oil, Rosemary, Salt, Pepper", instructions: "Cut potatoes, toss with oil and seasonings, roast until golden brown.", image_url: "https://placehold.co/600x400/d4a373/ffffff?text=Roasted+Potatoes" }
        ]
        # --- End Mock Data ---
        ...
        # Render the recipes array as JSON. This should return 200 OK even if @recipes is empty.
        render json: @recipes
      end
